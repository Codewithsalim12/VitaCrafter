...
import { MoveRight, Award, Star, Zap, CheckCircle, ClipboardEdit, Palette } from 'lucide-react';
...
const templates = [
  {
    ...
    image: 'https://gdoc.io/uploads/classic-resume-free-google-docs-template-t-712x984.webp',
  ...
  },
  {
    ...
    image: 'https://cdn.enhancv.com/predefined-examples/gtoz8KaPgvZJW6QL0qQqAN1YAucQLNzenvKdtL9r/image.png',
    hint: 'resume modern',
    badge: 'Trending',
  ...
  },
  {
    ...
    image: 'https://resumegenius.com/wp-content/uploads/Windsor-Creative-Resume-Template-Orange.png',
  ...
  },
  {
    ...
    image: 'https://staticlearn.shine.com/l/m/images/blog/mobile/what%20is%20a%20cv.webp',
    hint: 'resume photo',
    badge: 'New',
...
const features = [
  ...
  },
  {
    ...
    title: "Custom Colors",
    description: "Match your resume to your personal brand with custom color schemes"
  },
  {
    icon: <CheckCircle className="w-6 h-6" />,
    title: "ATS Friendly",
    description: "Optimized layouts that pass through applicant tracking systems"
  }
];
...
const testimonials = [
  {
    ...
    content: "Landed 3 interviews in the first week after using the Modern template!",
    rating: 5
  },
  {
    name: "Michael Chen",
    role: "Software Engineer",
    content: "The clean design helped me stand out from hundreds of applicants.",
    rating: 5
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              Select from our award-winning templates designed to highlight your strengths and get you noticed by recruiters.
            </p>
            <div className="mt-10 flex justify-center gap-4">
              <Button asChild size="lg" className="bg-gradient-to-r from-primary to-accent hover:from-accent hover:to-primary text-white font-bold rounded-lg px-8 py-4 shadow-lg text-lg transition-all duration-200">
                <Link href="#templates">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Our templates are designed to pass ATS scans while maintaining visual appeal. Select one that matches your industry and personality.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
          ...
          <div className="mt-16 bg-primary/5 border border-primary/20 rounded-2xl p-8 md:p-12 backdrop-blur-sm">
            <div className="max-w-4xl mx-auto text-center">
              <h3 className="text-2xl md:text-3xl font-bold mb-4">Ready to build your winning resume?</h3>
              <p className="text-lg text-muted-foreground mb-8">Join thousands of professionals who landed their dream jobs with our templates</p>
      ...
      <section className="py-16 md:py-24 lg:py-32 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Don't just take our word for it - hear from professionals who got results
            </p>
          </div>
            ...
            >
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="flex-1">
                  <p className="text-lg md:text-xl font-medium mb-4">"{testimonials[activeTestimonial].content}"</p>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {testimonials[activeTestimonial].name} &mdash; {testimonials[activeTestimonial].role}
                  </p>
                </div>
              </div>
            </div>
